...
const CategoryPage: React.FC<CategoryPageProps> = ({ toggleSignIn }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        // `http://webdev.cs.vt.edu:8080/IbrahimBookstoreReactSession/api/categories/name/${categoryName}/books`
        `http://localhost:8080/IbrahimBookstoreReactSession/api/categories/name/${categoryName}/books`
      )
      .then((result) => {
