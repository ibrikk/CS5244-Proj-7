...
const HomePage: React.FC<HomePageProps> = ({ toggleSignIn }) => {
  ...
  useEffect(() => {
    ...
    const fetchCategoryOneBooks = axios.get(
      "http://webdev.cs.vt.edu:8080/IbrahimBookstoreReactSession/api/categories/1001/books"
      // "http://localhost:8080/IbrahimBookstoreReactSession/api/categories/1001/books"
    );
    // Fetch category two books
    const fetchCategoryTwoBooks = axios.get(
      "http://webdev.cs.vt.edu:8080/IbrahimBookstoreReactSession/api/categories/1002/books"
      // "http://localhost:8080/IbrahimBookstoreReactSession/api/categories/1002/books"
    );
